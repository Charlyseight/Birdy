...
class MapBirdy extends Component {
    ...
    componentDidMount(){
      ...
      renderMap = () => {
        this.script("https://maps.googleapis.com/maps/api/js?key=AIzaSyBwtKOxhHmPCrSkL36crqsOEfYdQRABgIk&callback=initMap")
      }
    ...
    render() { 
        return (  
            <div id="map" style={{minHeight: "90vh", marginTop: "5.3rem" }}>
            </div>
