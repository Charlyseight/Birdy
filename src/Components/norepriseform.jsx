...
class NoRepriseForm extends Form {
    ...
    if (started !== true) {
      return (
        <div className="container" style={{ marginTop: 8 + "em" }}>
          <h1>Commencer une nouvelle capture</h1>
          <form onSubmit={this.handleStartCaptureSession}>
            ...
            <button
              type="submit"
              className="btn btn-primary h-margin-top--tiny h-margin-bottom--small"
            >
      ...
      return (
        <div className="container" style={{ marginTop: 8 + "em" }}>
          <h1 style={{ marginBottom: 1 + "em" }}>Capture d'un oiseau</h1>
  ...
  render() {
    return <React.Fragment>{this.session()}</React.Fragment>;
  }
}
